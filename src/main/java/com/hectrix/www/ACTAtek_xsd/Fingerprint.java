...
public class Fingerprint  implements java.io.Serializable {
    ...
    /**
     * Gets the image value for this Fingerprint.
     * 
     * @return image
     */
    ...
    /**
     * Sets the image value for this Fingerprint.
     * 
     * @param image
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.hectrix.com/ACTAtek.xsd", "Fingerprint"));
