...
@Entity
@Table(name = "\"IITM_GUEST_COUPON_ONLINE_PAYMENT_TRANSACTIONS\"", schema = ModelConstants.SCHEMA)
@Getter
@Setter
public class GuestCouponOnlinePaymentEntity extends CommonEntity {
    ...
    private GuestCouponPaymentAdviceEntity paymentAdvice;
