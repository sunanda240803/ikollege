...
@Setter
@Entity
@Table(name = "\"IIT_PS_TEMP_ACCOM_LEDGER_B\"", schema = "schooldev")
public class AccomodationLedgerBEntity extends CommonEntity {

	@EmbeddedId
	private AccomodationLedgerBEntityId id;
