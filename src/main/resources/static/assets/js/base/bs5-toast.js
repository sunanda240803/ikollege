  ...
  const bs5 = {
    Toast: class {
      ...
      constructor(param) {
        ...
        this.#placement = this.#setOption(param.placement, "top-center");
        ...
        let style = `style="margin:${this.#margin};${this.#pos[0]}:0;left:50%;transform:translateX(-50%);${this.#animation ? "top:-50%" : "top:0"};z-index:1081"`;
