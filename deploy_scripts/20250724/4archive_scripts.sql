...
create table IF NOT EXISTS archive.archive_table_master
(
    id          bigserial,
...
VALUES ('EVENT_ACCOMMODATION_STUDENT_DETAILS', 'student_id = %L', 'Y', 1),
       ...
       ('STUDENT_MESS_LOGIN_ISSUE_PRIORITY', 'student_id = %L', 'Y', 54),
...
begin
    ...
    perform public.dblink_exec(
                   'host=10.24.8.107 port=5432 dbname=iitchennai user=postgres password=W$lkl3TlPo'::text,
